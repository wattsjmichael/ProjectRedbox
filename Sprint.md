...
* [ ] **0:00–0:20 — Run timer** — Add 10-minute run clock
...
* [ ] **0:00–0:15 — Boss warning** — `WARNING: WYRM DETECTED`
...
* [ ] **0:00–0:20 — Boss fight** — HP + attack tuning
...
* [ ] **0:00–0:15 — Dadbod splash** — `DADBOD STUDIOS PRESENTS`
...
* [ ] **0:00–0:15 — Production build** — Build HTML5 version
